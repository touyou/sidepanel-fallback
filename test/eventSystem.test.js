...
describe('Event System', () => {
  ...
  describe('SidepanelFallback Event Integration', () => {
    ...
    it('should emit panel operation events', async () => {
      ...
      expect(afterOpen).toHaveBeenCalledWith(expect.objectContaining({
        path: '/test.html',
    ...
    it('should emit settings change events', async () => {
      ...
      expect(beforeChange).toHaveBeenCalledWith(expect.objectContaining({
        oldMode: 'auto',
        newMode: 'sidepanel',
        browser: 'firefox'
      }));
      
      expect(storageWrite).toHaveBeenCalledWith(expect.objectContaining({
        browser: 'firefox',
        mode: 'sidepanel'
      }));
      
      expect(modeChanged).toHaveBeenCalledWith(expect.objectContaining({
        oldMode: 'auto',
        newMode: 'sidepanel',
        browser: 'firefox'
      }));
      
      expect(afterChange).toHaveBeenCalledWith(expect.objectContaining({
        oldMode: 'auto',
        newMode: 'sidepanel',
        browser: 'firefox'
      }));
